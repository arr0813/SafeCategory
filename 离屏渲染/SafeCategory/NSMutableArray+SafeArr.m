//
//  NSMutableArray+SafeArr.m
//
//  Created by 青州扛把子 on 2018/3/28.
//  Copyright © 2018年 青州扛把子. All rights reserved.
//

#import "NSMutableArray+SafeArr.h"

#import <objc/runtime.h>

#import <UIKit/UIKit.h>

@implementation NSMutableArray (SafeArr)
...
- (instancetype)safe_objectAtIndex:(NSUInteger)index
{
    ...
    { 
        ...
        UIAlertController * alert = [UIAlertController alertControllerWithTitle:@"可变数组越界" message:@"通过objectAtIndex方法调用" preferredStyle:UIAlertControllerStyleAlert];
...
-(instancetype)safe_objectAtIndexedSubscript:(NSUInteger)index
{
    ...
    {
        //NSLog(@"-------- %@", [exception callStackSymbols]);
        UIAlertController * alert = [UIAlertController alertControllerWithTitle:@"可变数组越界" message:@"通过arr[]方法调用" preferredStyle:UIAlertControllerStyleAlert];
